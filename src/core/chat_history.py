...
load_dotenv()
MONGO_URI = os.getenv("MONGO_URI", "mongodb://192.168.60.129:27017")
MONGO_DB_NAME = os.getenv("MONGO_DB_NAME", "test_chatesb")
MONGO_COLLECTION_CHAT_STUD = os.getenv("MONGO_COLLECTION_CHAT_STUD", "history_student")
