'use client';
import { Box, Input, Button, VStack, Text, Flex, Icon, Image, InputGroup, InputLeftElement, Menu, MenuButton, MenuList, MenuItem, HStack } from '@chakra-ui/react';
          ...
          >
            ...
            <VStack spacing="5px" align="start">
              <Text
                ...
                onClick={() => handleExampleClick("Show me all pending student requests.")}
              >"Show me all pending student requests."</Text>
              <Text
                as="span"
                cursor="pointer"
                _hover={{ textDecoration: 'underline', color: 'red.500' }}
                onClick={() => handleExampleClick("How many students are registered this semester?")}
              >"How many students are registered this semester?"</Text>
              <Text
                as="span"
                cursor="pointer"
                _hover={{ textDecoration: 'underline', color: 'red.500' }}
                onClick={() => handleExampleClick("Generate a report for course enrollments.")}
              >"Generate a report for course enrollments."</Text>
              <Text
                as="span"
                cursor="pointer"
                _hover={{ textDecoration: 'underline', color: 'red.500' }}
                onClick={() => handleExampleClick("List all upcoming administrative meetings.")}
              >"List all upcoming administrative meetings."</Text>
              <Text
                as="span"
                cursor="pointer"
                _hover={{ textDecoration: 'underline', color: 'red.500' }}
                onClick={() => handleExampleClick("Update the academic calendar.")}
              >"Update the academic calendar."</Text>
            </VStack>
          </Box>
        </Flex>
      </Flex>
