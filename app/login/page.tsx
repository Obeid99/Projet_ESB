'use client';
import { Box, Button, Input, VStack, Text, Flex, Checkbox, Image, InputGroup, InputRightElement, IconButton, useToast, Alert, AlertIcon } from '@chakra-ui/react';
...
export default function LoginPage() {
  ...
  // Backend integration: handleLogin
  ...
  // Backend integration: handleRegister
        ...
        <Box flex={1} bgGradient="linear(to-br, red.500, red.400)" color="white" display="flex" flexDirection="column" alignItems="center" justifyContent="center" p={{ base: 6, md: 10 }}>
          ...
          <Button
            ...
            onClick={() => {
              setIsFlipped(true);
              setTimeout(() => {
                // Center the register form after flip
